	...
	*/
	...
	DrawingBoard.Board.prototype = {
		...
		initDrawEvents: function() {
			...
			this.dom.$canvas.on('mousedown touchstart', (e) => {
				this._onInputStart(e, this._getInputCoords(e) );
			});
	
			this.dom.$canvas.on('mousemove touchmove', (e) => {
				this._onInputMove(e, this._getInputCoords(e) );
			});
	
			this.dom.$canvas.on('mouseup touchend', (e) => {
				this._onInputStop(e, this._getInputCoords(e) );
			});
	
			this.dom.$canvas.on('mouseover', (e) => {
				this._onMouseOver(e, this._getInputCoords(e) );
			});
	
			this.dom.$canvas.on('mouseout', (e) => {
    ...
    handleSimulatedEvent: function (e) {
